    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container py-8">
        <div className="card p-8 max-w-4xl mx-auto border border-gray-200 rounded-lg shadow-sm">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Analytics Overview</h2>
          <p className="text-gray-600 text-lg leading-relaxed">Detailed analytics and data insights</p>
          <div className="mt-6">
      ...
      <div className="container py-12">
        <h2 className="text-3xl font-bold mb-8 text-center">Website Traffic</h2>
      ...
      <div className="container py-12">
        <h2 className="text-3xl font-bold mb-8 text-center">Top Performing Pages</h2>
